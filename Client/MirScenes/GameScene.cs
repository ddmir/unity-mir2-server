...
namespace Client.MirScenes
{
    ...
    public sealed class MapControl : MirControl
    {
        ...
        public MapControl()
        {
            ...
            Console.WriteLine(ViewRangeX);
            Console.WriteLine(ViewRangeY);
        ...
        private void DrawFloor()
        {
            ...
            // Console.WriteLine("M2CellInfo: start");

            Console.WriteLine((M2CellInfo[0, 0].BackImage & 0x1FFFFFFF) - 1);


            // Console.WriteLine(M2CellInfo[0, 0].BackIndex);
            // Console.WriteLine(M2CellInfo[0, 0].BackImage);
            // Console.WriteLine(M2CellInfo[0, 0].MiddleIndex);
            // Console.WriteLine(M2CellInfo[0, 0].MiddleImage);
            // Console.WriteLine(M2CellInfo[0, 0].FrontImage);
            // Console.WriteLine(M2CellInfo[0, 0].DoorIndex);
            // Console.WriteLine(M2CellInfo[0, 0].DoorOffset);
            // Console.WriteLine(M2CellInfo[0, 0].FrontAnimationFrame);
            // Console.WriteLine(M2CellInfo[0, 0].FrontAnimationTick);
            // Console.WriteLine(M2CellInfo[0, 0].FrontIndex);
            // Console.WriteLine(M2CellInfo[0, 0].Light);
            // Console.WriteLine(M2CellInfo[0, 0].Unknown);
            // Console.WriteLine(M2CellInfo[0, 0].Light);
            // Console.WriteLine(M2CellInfo[0, 0].FishingCell);
