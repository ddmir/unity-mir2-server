...
namespace Server.MirEnvir
{
	...
	public class Envir
	{
		...
		private void StartNetwork()
		{
			...
			LoadConquests();
			MessageQueue.Enqueue("ip:"+IPAddress.Parse(Settings.IPAddress)+" port:"+Settings.Port);
			...
			{
				_StatusPort = new TcpListener(IPAddress.Parse(Settings.IPAddress), 3000+Random.Next(1,10));
				_StatusPort.Start();
